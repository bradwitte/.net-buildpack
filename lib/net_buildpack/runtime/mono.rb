...
module NETBuildpack::Runtime
  ...
  class Mono < NETBuildpack::BaseComponent
    ...
    def max_heap
      ...
      memory_limit_size = NETBuildpack::Util::MemorySize.new("400M") #NETBuildpack::Util::MemorySize.new(memory_limit) - NETBuildpack::Util::MemorySize.new("48M")
    ...
    def create_start_script
      ...
      File.chmod(0755, start_script_path) # -r-xr-xr-x -> Read & Execute
